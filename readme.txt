...
This guide will explain how to run and use the software made for this project. The program runs tests on models selected by the 
...
entry of each column. An example of compatible data can be found on kaggle. This small data set contains the
 price of a fiat-500 based on 7 features. 
The data set can be found here:

https://www.kaggle.com/paolocons/another-fiat-500-dataset-1538-rows.

I have included this data set in the program directory so it can be used for testing.
